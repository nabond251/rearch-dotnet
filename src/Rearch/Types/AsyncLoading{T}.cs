...
///
/// To be in this state, a new <see cref="Task{TResult}"/> or <see cref="IObservable{T}"/> has not emitted
...
public sealed class AsyncLoading<T> : AsyncValue<T>
{
    ...
    public override bool Equals(object? obj) =>
            obj is AsyncLoading<T> asyncLoading && asyncLoading.PreviousData.Equals(this.PreviousData);

    /// <inheritdoc/>
    public override string ToString() => $"AsyncLoading(previousData: {this.PreviousData})";
